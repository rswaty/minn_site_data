...
hwy61_understory <- understory_data_updated %>%
...
grouped_species <- hwy61_understory %>%
...
## Understory species and DBH  hwy61_understory

<br>
```{r understory click, echo=FALSE, message=FALSE, warning=FALSE, fig.height= 9, fig.width= 9}

sd_understory_data_updated <- highlight_key(hwy61_understory)
